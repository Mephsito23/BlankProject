...
- (instancetype)initWithOrigin:(CGPoint)origin Width:(CGFloat)width Height:(CGFloat)height Type:(XTDirectionType)type Color:(UIColor *)color
{
    ...
    if (self) {
        self.backgroundColor = [UIColor colorWithRed:.3 green:.3 blue:.3 alpha:.3];
        // 箭头的位置
        self.origin = origin;
        // 视图的宽度
        self.width = width;
        ...
        self.backGoundView.layer.cornerRadius =8;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIView*line = [[UIView alloc]initWithFrame:CGRectMake(0, 40, kScreenWidth, 1)];
